 ...
 *
 * Classes/Functions:
 *   - if (!supabaseUrl || !supabaseAnonKey) (line 58)
 *   - export const getNamesWithDescriptions = async () => (line 67)
 *   - if (hiddenError) (line 74)
 *   - if (hiddenIds.length > 0) (line 95)
 *   - if (error) (line 102)
 *   - export const ensureRatingHistoryTable = async () => (line 120)
 *   - if (!tableExists) (line 129)
 *   - devLog('Created rating_history table'); (line 133)
 *   - if (error) (line 168)
 *   - if (error.code === "42P01") (line 170)
 *   - if (fetchError && fetchError.code !== "PGRST116") (line 211)
 *   - if (outcome === "win") (line 223)
 *   - if (existingData) (line 230)
 *   - if (error) (line 265)
 *   - export const getRatingHistory = async (userName, nameId = null, limit = 20) => (line 288)
 *   - if (nameId) (line 297)
 *   - if (error) (line 303)
 *   - if (error.code === "42P01") (line 305)
 *   - export const deleteName = async (nameId) => (line 320)
 *   - if (nameError?.code === "PGRST116") (line 329)
 *   - if (!nameData) (line 337)
 *   - if (hiddenError) (line 347)
 *   - if (!hiddenData || hiddenData.length === 0) (line 352)
 *   - if (error1) (line 361)
